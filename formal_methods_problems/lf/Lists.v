...
Example test_nonzeros:
  nonzeros [0;1;0;2;3;0;0] = [1;2;3]. simpl. reflexivity. Qed.
...
Proof.
  ...
  - {
      induction l2 as [| n' l'' IHl''].
      - simpl. rewrite -> app_nil_r. reflexivity.
      - simpl. rewrite -> IHl'. simpl. rewrite -> app_assoc. reflexivity.
    }
  Qed.
...
Theorem n_equal_n : forall n, true = (n =? n).
Proof.
...
Proof.
  intros l. induction l as [| n l' IHl' ].
  - reflexivity.
  - simpl. rewrite <- n_equal_n. rewrite <- IHl'. reflexivity.
  Qed.
(** [] *)
...
Proof.
  ...
  - reflexivity.
  - simpl. rewrite <- n_equal_n. simpl. reflexivity. Qed.
(** [] *)
