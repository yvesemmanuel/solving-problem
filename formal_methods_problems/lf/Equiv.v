...
Proof.
  ...
  split; intros H.
  - (* -> *)
    inversion H. subst. (* substitute terms *)
    inversion H5. subst.
    assumption. (* the final state is the same *)
  - (* <- *)
    apply E_Seq with st'. (* use the definition of ; *)
    * assumption. (* the initial state is the same *)
    * apply E_Skip. (* the skip command does not change the state *)
  Qed.
(** [] *)
...
Proof.
  ...
  split; intros H.
  - (* Prove one direction of the equivalence *)
    inversion H; subst.
    * apply E_IfFalse.
      simpl. rewrite H5.
      reflexivity.
    ...
    * apply E_IfTrue.
      ...
      reflexivity.
      apply H6.
  - (* Prove the other direction of the equivalence *)
    inversion H; subst.
    * apply E_IfFalse.
      simpl in H5.
...
Proof.
  ...
  - inversion H0; subst.
    ...
    + apply E_WhileTrue with st'.
      * rewrite H. inversion H4. reflexivity.
Admitted.
(*      * apply E_Seq with st'0.
        { apply H2. }
        { apply (E_Skip st'0 st'). }
Qed. *)
