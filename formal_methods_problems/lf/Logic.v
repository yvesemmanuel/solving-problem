...
Theorem contrapositive : forall (P Q : Prop),
  (P -> Q) -> (~Q -> ~P).
Proof.
  intros P Q H H0. unfold not. intros HP.
  (* aplicando H0 para gerar contradição *)
  apply H0. apply H. apply HP.
  Qed.
(** [] *)
...
Proof.
  ...
  - intros H. split.
    ...
    + destruct H as [HP | [HQ HR]].
      ...
      * right. apply HR.
  - intros [PvQ PvR].
    destruct PvQ as [HP | HQ].
      + left. apply HP.
      + destruct PvR as [HP | HR].
        * left. apply HP.
        * right. split.
          ** apply HQ.
          ** apply HR.
...
Proof.
  intros X P H. unfold not. intro H1.
...
Proof.
  ...
  - intros H.
    ...
    + inversion H.
    + simpl in H.
      destruct H as [Fx | InL].
      * exists x. split.
        ** apply Fx.
        ** simpl. left. reflexivity.
      * apply IH in InL.
        destruct InL as [x' [Fx' InL']].
        exists x'. split.
          *** apply Fx'.
          *** simpl. right. apply InL'.
   - intros H.
     destruct H as [x [Fx InL]].
     induction l as [| x' l' IH].
     + apply InL.
     + simpl.
       destruct InL as [Xeq | InX'].
       * left.
         rewrite <- Fx.
         rewrite <- Xeq.
         reflexivity.
...
Proof.
  ...
  - intros l' a. split.
    ...
    + intros H.
      simpl.
      destruct H as [InE | InL'].
      * inversion InE.
      * apply InL'.
  - intros l'' a. split.
    + intros H.
      simpl in H.
      destruct H as [Eqa | InL].
      * simpl.
        left. left.
        apply Eqa.
      * apply IHl' in  InL.
        ...
        ** right.
           apply InL''.
   + intros H.
     destruct H as [InL' | InL''].
     * destruct InL' as [Eqa | InL'].
       ** simpl.
          left.
          apply Eqa.
       ** simpl.
...
Proof.
  ...
  - intros H. destruct (evenb_double_conv n) as [k Hk].
    rewrite Hk. rewrite H. exists k. Admitted.
