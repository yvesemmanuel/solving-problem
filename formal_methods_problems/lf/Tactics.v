...
Theorem rev_exercise1 : forall (l l' : list nat),
     ...
     l' = rev l.
Proof.
  intros l l' eq. induction l' as [| n l' IHl].
  - symmetry.
    rewrite -> eq.
    reflexivity.
  - rewrite -> eq.
...
Example discriminate_ex3 :
  forall (X : Type) (x y z : X) (l j : list X),
    ...
    x = z.
Proof.
  intros X x y z l j eq0.
  discriminate eq0. Qed.
(** [] *)
...
(** **** Exercise: 2 stars, standard (eq  b_true)  *)
...
Proof.
  ...
  - destruct (f false) eqn:EqF.
    + destruct b.
      * rewrite -> EqT. rewrite -> EqT. rewrite -> EqT.
        reflexivity.
      * rewrite -> EqF. rewrite -> EqT. rewrite -> EqT.
        reflexivity.
    + destruct b.
      * rewrite -> EqT. rewrite -> EqT. rewrite -> EqT.
        reflexivity.
      * rewrite -> EqF. rewrite -> EqF. rewrite -> EqF.
        reflexivity.
  - destruct (f false) eqn:EqF.
    + destruct b.
      * rewrite -> EqT. rewrite -> EqF. rewrite -> EqT.
        reflexivity.
      * rewrite -> EqF. rewrite -> EqT. rewrite -> EqF.
        reflexivity.
    + destruct b.
       * rewrite -> EqT. rewrite -> EqF. rewrite -> EqF.
          reflexivity.
       * rewrite -> EqF. rewrite -> EqF. rewrite -> EqF.
          reflexivity.
  Qed.
