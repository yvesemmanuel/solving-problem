...
Proof.
  ...
  split.
  - constructor.
  - intros H. apply H. exists (C 2). constructor.
Qed.
End Temp1.
...
Proof.
  ...
  - destruct IHt1 as [IH1 | [t1' H1]].
    + destruct IHt2 as [IH2 | [t2' H2]].
      * inversion IH1. inversion IH2. Admitted.
...
Proof.
  ...
  try solve [inversion H]; try reflexivity.
  inversion H4.
Admitted.
(** [] *)
